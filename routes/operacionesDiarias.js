...
router.get('/listar-pedidos/:registroDiarioId', operacionesDiariasController.listarPedidos);
...
router.get('/pedido-monto-total/:registro_diario_id',operacionesDiariasController.pedidoMontoTotalDiario);
router.put('/cierre-caja',operacionesDiariasController.cierrCaja);
router.get('/registros-diarios/:filtro',operacionesDiariasController.reporteOperacionesDiarias);
router.get('/registros-diarios/:id/detalle',operacionesDiariasController.reporteOperacionesDiariasDetalle);
router.get('/caja-inicial/:registro_diario_id',operacionesDiariasController.getCajaInicial);
router.delete('/borrar-pedido/:id', pedidosController.deletePedido);
